...
(
	...
	ativo                 boolean                   default true, /* 0 - NAO; 1 - SIM;  */
...
(
	...
	ativo            boolean       not null,  /* 0 - NAO; 1 SIM; */
...
(
	...
	debooleano          decimal(10,2) not null        default 0,
...
(
	...
	descricao    varchar(100) not null,
	fracionado   boolean      not null  default 0,  /* 0 - NAO; 1 - SIM */
...
(
	...
	inativo     boolean       not null  default 0,  /*  0 - NÃO; 1 - SIM;  */
...
(
	...
	preco_padrao   boolean           not null   default 1,
...
(
	...
	local_padrao      boolean            not null  default 0,
...
(
	...
	debooleano_horas_recebimento    int         not null default 0,
...
(
	...
	permite_entrada       boolean           not null  default 0, /* 0 - NAO; 1 - SIM; Se o cliente pode dar uma entrada de R$300,00 e parcelar o resto */
...
(
	...
	gera_comissao             boolean           not null    default 0, /* 0 - NAO; 1 - SIM */
	gera_nfe                  boolean           not null    default 0, /* 0 - NAO; 1 - SIM*/
	gera_nfce                 boolean           not null    default 0, /* 0 - NAO; 1 - SIM */
	inativo                   boolean           not null    default 0, /* 0 - NAO; 1 - SIM */    
...
(
	...
	efetivado             boolean         not null   default 0,
	obs                   varchar(1000),
